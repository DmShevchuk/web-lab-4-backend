...
import { toastRemoved } from './features/toasts/toastsSlice';
    ...
    return (
        <div className='w-full pt-3 min-h-screen stripes-background'>
            <header className='mb-7 mx-auto bg-gray-100 w-[90%] px-5 py-3 rounded-xl shadow-lg flex flex-row flex-nowrap items-center justify-between'>
                <div>
                    <h1 className='text-xl font-extrabold md:text-2xl'>Лабораторная работа №4</h1>
                    <h2 className='text-sm md:text-xl'>Шевчук Дмитрий | P32312 | Вариант 336766 </h2>
                </div>
                { authenticated && 
